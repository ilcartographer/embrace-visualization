...
class LoadDataForm:
    ...
    def submit(self, data):
        ...
        self.submit_load_action("C:/Users/jdick/Downloads/embrace-visualization/Dataset/20200120/312/summary.csv")
...
class TimeSeriesBuilder:
    ...
    def add_widgets(self):
        ...
        right_arrow_button = Button(second_frame_horizontal, height = 20, width = 40, image = right_arrow_photo, command=lambda: self.move_selections(lb_available, lb_selected))
        ...
        left_arrow_button = Button(second_frame_horizontal, height = 20, width = 40, image = left_arrow_photo, command=lambda: self.move_selections(lb_selected, lb_available))
    ...
    def move_selections(self, lb_origin, lb_destination):
        #selected_option_indices = lb_origin.curselection()
        #print(selected_option_indices)
        for option_index in lb_origin.curselection():
            print(option_index)
            print(lb_origin.get(option_index))
        ...
        selected_option_indices = lb_origin.curselection()
        cur_index = 0
        while len(selected_option_indices) > 0:
            index = selected_option_indices[cur_index]
            lb_destination.insert(index, lb_origin.get(index))
            lb_origin.delete(index)
            cur_index +=1
        '''
